...
- (void)windowDidLoad {
	...
	RACSignal *labelWidth = [RACSignal max:@[ nameLabel.rcl_intrinsicWidthSignal, emailLabel.rcl_intrinsicWidthSignal ]];
	...
	RACTupleUnpack(RACSignal *nameRect, RACSignal *emailRect) = [[self.contentView.rcl_frameSignal
		...
		divideWithAmount:nameField.rcl_intrinsicHeightSignal padding:padding fromEdge:CGRectMaxYEdge];
	...
	RACTupleUnpack(RACSignal *emailLabelRect, RACSignal *emailFieldRect) = [[emailRect
		sliceWithAmount:emailField.rcl_intrinsicHeightSignal fromEdge:CGRectMaxYEdge]
